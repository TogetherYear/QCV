...
QT_MOC_LITERAL(1, 9, 14), // "OnYourShortcut"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "Shortcut\0OnYourShortcut\0"
};
...
void Shortcut::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->OnYourShortcut(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Shortcut::OnYourShortcut)) {
                *result = 0;
                return;
            }
        }
...
void *Shortcut::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Singleton<Shortcut>"))
        return static_cast< Singleton<Shortcut>*>(this);
